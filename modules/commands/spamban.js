 module.exports.config = {
  ...
  description: "tự động cấm người dùng nếu spam bot 5 lần/10s",
...
module.exports. run = ({api, event, args, Users,Threads}) => {
  return api.sendMessage("đã bật chế độ tự động ban người dùng sử dụng quá 5 lần/100s (mày ngon spam bot tao xem)", event.threadID, event.messageID);
};
